...
function Footer() {
  return (
    ...
    <footer className="flex justify-center gap-4 py-4 bg-gray-100 px-5">
        <button className="bg-white w-full h-12 flex justify-center items-center rounded-[10px] shadow">
